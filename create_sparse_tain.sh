...
librispeech_subdir=/data/rigel1/corpora/LibriSpeech/LibriSpeech/train-clean-100/ # path to LibriSpeech test-clean
noise_dir=/data/work95/marc/wham/wham_noise/tt # path to test WHAM noises
metadata_dir=./metadata
out_dir=/home/jpeng/ntt/work/Data/sparse_libri_def/train # output directory
stage=0
fs=16000
out_json=$metadata_dir/train/metadata.json
